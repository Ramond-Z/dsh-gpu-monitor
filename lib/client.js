...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    function injectTheme() {
      ...
      s.textContent =
        ".dsh-gpu-monitor{--gpu-bg:#0f1116;--gpu-fg:#dbe0ea;--gpu-fg-dim:rgba(219,224,234,.55);" +
        "--gpu-border:#232833;--gpu-head:#151924;--gpu-card:#1a1f2c;--gpu-track:#2a3040;" +
        "--gpu-shadow:0 6px 20px rgba(0,0,0,.45)}" +
        "@media (prefers-color-scheme: light){.dsh-gpu-monitor{--gpu-bg:rgba(255,255,255,.98);" +
        "--gpu-fg:#23272f;--gpu-fg-dim:rgba(35,39,47,.55);--gpu-border:#e3e6ec;--gpu-head:#f4f5f9;" +
        "--gpu-card:#ffffff;--gpu-track:#e9ecf2;--gpu-shadow:0 6px 20px rgba(15,18,30,.10)}}" +
