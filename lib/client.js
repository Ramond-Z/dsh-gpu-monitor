  ...
  factory: (require) => {
    ...
    function injectTheme() {
      ...
      s.textContent =
        ...
        ".dsh-gpu-monitor .gpu-sys{display:flex;gap:4px;flex:0 0 auto;min-height:44px}" +
        ...
        ".dsh-gpu-monitor .gpu-sys-track{position:relative;flex:1;width:10px;border-radius:5px;overflow:hidden;" +
