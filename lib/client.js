  ...
  factory: (require) => {
    ...
    function injectTheme() {
      ...
      s.textContent =
        ...
        // 百分数放在条**下方横排**（条内只有 14px 宽，竖排数字难读）；align-self:stretch 让细条
        // 与方块网格同高；track 的 min-height 兜底：高度链万一算不出来也不会被压成 0。
        ...
        ".dsh-gpu-monitor .gpu-sys-val{flex:none;font-size:8px;font-weight:700;line-height:1;color:var(--gpu-fg);white-space:nowrap}" +
