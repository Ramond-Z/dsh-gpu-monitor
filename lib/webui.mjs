...
/** 页面骨架（顶栏状态条；data-gpu-theme=dark 强制深色，避免系统浅色模式下"黑底浅框"）。 */
export const INDEX_HTML = `<!DOCTYPE html>
<html lang="zh-CN" data-gpu-theme="dark" style="color-scheme: dark">
<head>
  <meta charset="utf-8">
  ...
  <style>
    ...
    .app-bar .title { font-size: 14px; font-weight: 650; letter-spacing: .2px; }
    .app-bar .meta { margin-left: auto; font-size: 12px; color: rgba(219,224,234,.55); }
